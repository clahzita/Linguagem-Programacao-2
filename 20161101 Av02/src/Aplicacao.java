...
public class Aplicacao {
	...
	public static void main(String[] args) {
		...
		teste.listarEmpregados();
		
		try{
			teste.inserirFornecedor(new Fornecedor("Laura", "Rua c", "444", "fem", 1980, 15000, 5000));
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
		
		teste.listarFornecedores();
		
		
		try{
			teste.inserirSetor(new Setor(90, "RH"));
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
